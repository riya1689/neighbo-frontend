...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Top Navbar */}
      <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 fixed top-0 w-full z-20 shadow-sm">
        <div className="flex items-center gap-2">
           <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-poppins font-bold text-2xl text-primary tracking-tight hidden md:block">Neighbo</span>
          </Link>
      ...
      <div className="flex pt-20">
        {/* Sidebar */}
        <aside className="w-72 bg-white border-r border-slate-200 flex flex-col fixed h-[calc(100vh-80px)] z-10 p-6">
        ...
        {/* Main Content */}
        <main className="flex-1 ml-72 p-8 min-h-[calc(100vh-80px)]">
           {children}
        </main>
      </div>
    </div>
