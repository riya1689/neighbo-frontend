  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-800 font-poppins tracking-tight">Following</h1>
          <p className="text-slate-500 mt-1">Neighbors you follow for updates.</p>
        </div>
      </div>

      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
        <div className="p-8 border-b border-slate-50 flex items-center justify-between">
           <h3 className="font-bold text-slate-800 font-poppins">{following.length} Total Following</h3>
        ...
        <div className="p-8">
          {loading ? (
            ...
            <div className="rounded-[2rem] border border-dashed border-slate-200 bg-slate-50/30 py-20 text-center">
              ...
              <h3 className="font-bold text-slate-800">Following no one yet</h3>
              <p className="text-sm text-slate-500 mt-2">Explore your neighborhood to find interesting people.</p>
            </div>
          ) : (
