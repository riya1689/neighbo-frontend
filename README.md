...
## Project Overview
The Neighbo Frontend is a high-performance web application built with **Next.js 16**, **React.js**, **TypeScript**, **Tailwind CSS**. It provides a sleek, interactive interface for users to connect with their neighbors, discover local events, and access premium community content. The UI is designed with a focus on usability, speed, and premium aesthetics.
...
## Design System
The project follows a **3-columns layout** for desktop and **1-column** layout for mobile.
